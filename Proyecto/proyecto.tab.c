...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_translation_unit = 27,          /* translation_unit  */
  YYSYMBOL_external_declaration = 28,      /* external_declaration  */
  YYSYMBOL_function_definition = 29,       /* function_definition  */
  YYSYMBOL_declaration_specifiers = 30,    /* declaration_specifiers  */
  YYSYMBOL_type_specifier = 31,            /* type_specifier  */
  YYSYMBOL_declarator = 32,                /* declarator  */
  YYSYMBOL_direct_declarator = 33,         /* direct_declarator  */
...
{
       0,    55,    55,    56,    60,    62,    66,    67,    71,    75,
      76,    77,    81,    85,    86,    90,    91,    95,    96,   100,
     101,   104,   105,   109,   113,   114,   118,   119,   126,   132,
     133,   141,   144,   153,   156,   157,   161,   162,   163,   167,
     168,   169,   173,   174,   175,   179,   180,   184,   185
};
#endif
...
static const char *const yytname[] =
{
  ...
  "STRING_LITERAL", "CHAR", "INT", "VOID", "CONSTANT", "EQ_OP", "IF",
  "WHILE", "RETURN", "'('", "')'", "'{'", "'}'", "';'", "'='", "'-'",
  ...
  "expression_statement", "expression", "declaration_list", "declaration",
  "init_declarator_list", "init_declarator", "primary_expression",
...
{
       7,   -28,   -28,   -28,    42,   -28,   -28,    -1,   -28,   -28,
     -28,   -28,    43,   -28,    38,   -10,    20,   -28,     2,     7,
       5,   -28,    38,   -28,    40,   -28,   -28,    28,     8,   -28,
     -28,   -28,    30,    33,    39,    47,   -28,    23,    48,   -28,
     -28,   -28,     2,   -28,   -28,     8,     8,     8,     8,     8,
       8,     8,   -28,   -28,   -28,    17,   -28,   -28,    50,   -28,
     -28,   -28,   -28,    30,    30,    39,    39,    39,   -28,   -28,
     -28
};
...
{
       0,    10,    11,     9,     0,     2,     4,     0,     8,     5,
       1,     3,    13,    26,     0,    12,     0,    28,     0,     0,
       0,     7,     0,    24,     0,    27,    32,    31,     0,    33,
      34,    36,    39,    42,    45,    47,    30,     0,    29,     6,
      25,    14,     0,    31,    35,     0,     0,     0,     0,     0,
       0,     0,    15,    21,    19,     0,    17,    20,     0,    23,
      48,    37,    38,    41,    40,    43,    44,    46,    16,    18,
      22
};
...
{
     -28,   -28,    65,   -28,    32,   -28,   -28,   -28,    -6,   -28,
      15,   -28,   -28,    52,   -12,   -28,   -28,   -28,   -28,   -27,
      18,   -28,     9,   -28,   -18
};
...
{
      -1,     4,     5,     6,    20,     8,    14,    15,    54,    55,
      56,    57,    58,    22,     9,    16,    17,    29,    30,    31,
      32,    33,    34,    35,    59
};
...
{
      36,    44,    23,    12,    24,    26,    27,    23,    21,    38,
      40,    26,    43,     1,     2,     3,    39,    13,    61,    62,
      26,    27,    28,    13,    60,    40,    26,    27,    28,     1,
       2,     3,     7,    19,    68,    53,     7,    28,    25,    19,
      52,    53,    10,    28,     1,     2,     3,    42,     1,     2,
       3,    45,    46,    47,    19,    41,    48,    51,    65,    66,
      67,   -29,    18,    49,    50,    63,    64,    18,    70,    11,
      69,    37
};

static const yytype_int8 yycheck[] =
{
      18,    28,    14,     4,    14,     3,     4,    19,    14,     4,
      22,     3,     4,     6,     7,     8,    22,    18,    45,    46,
       3,     4,    20,    18,    42,    37,     3,     4,    20,     6,
       7,     8,     0,    16,    17,    18,     4,    20,    18,    16,
      17,    18,     0,    20,     6,     7,     8,    19,     6,     7,
       8,    21,    22,    20,    16,    15,    23,    10,    49,    50,
      51,    18,    19,    24,    25,    47,    48,    19,    18,     4,
      55,    19
};
...
{
       0,     6,     7,     8,    27,    28,    29,    30,    31,    40,
       0,    28,     4,    18,    32,    33,    41,    42,    19,    16,
      30,    34,    39,    40,    14,    18,     3,     4,    20,    43,
      44,    45,    46,    47,    48,    49,    50,    39,     4,    34,
      40,    15,    19,     4,    45,    21,    22,    20,    23,    24,
      25,    10,    17,    18,    34,    35,    36,    37,    38,    50,
      50,    45,    45,    46,    46,    48,    48,    48,    17,    36,
      18
};
...
#line 60 "proyecto.y"
                                        {//printf("agrega funcion %s a la tala de simbolos\n",$1);
								}
#line 1193 "proyecto.tab.c"
    break;

  case 7: /* function_definition: declaration_specifiers declarator compound_statement  */
#line 67 "proyecto.y"
                                                               {}
#line 1199 "proyecto.tab.c"
    break;

  case 8: /* declaration_specifiers: type_specifier  */
#line 71 "proyecto.y"
                                {(yyval.tipo) = (yyvsp[0].tipo);}
#line 1205 "proyecto.tab.c"
    break;
...
#line 1229 "proyecto.tab.c"
  ...
  case 13: /* direct_declarator: IDENTIFIER  */
#line 85 "proyecto.y"
                                {(yyval.cad)=(yyvsp[0].cad);}
#line 1235 "proyecto.tab.c"
    break;

  case 14: /* direct_declarator: direct_declarator '(' ')'  */
#line 86 "proyecto.y"
                                        {(yyval.cad) = (yyvsp[-2].cad);}
#line 1241 "proyecto.tab.c"
    break;

  case 15: /* compound_statement: '{' declaration_list '}'  */
#line 90 "proyecto.y"
                                   {}
#line 1247 "proyecto.tab.c"
    break;
...
#line 1253 "proyecto.tab.c"
  ...
  case 27: /* declaration: declaration_specifiers init_declarator_list ';'  */
#line 119 "proyecto.y"
                                                         {AgregaVar((yyvsp[-2].tipo),(yyvsp[-1].s));
											fprintf(f1,"const v%d, 0x%x\n",(yyvsp[-1].s)->registro,(yyvsp[-1].s)->val);
													
	}
#line 1262 "proyecto.tab.c"
    break;
...
#line 1270 "proyecto.tab.c"
    break;

  case 29: /* init_declarator: IDENTIFIER  */
#line 132 "proyecto.y"
                                                        {(yyval.s)->nombre = strdup((yyvsp[0].cad));}
#line 1276 "proyecto.tab.c"
    break;

  case 30: /* init_declarator: IDENTIFIER '=' assignment_expression  */
#line 133 "proyecto.y"
                                                {(yyval.s)->nombre = strdup((yyvsp[-2].cad));
											(yyval.s)->val = tabla_de_simbolos[buscaPorReg((yyvsp[0].d))].val;
											}
#line 1284 "proyecto.tab.c"
    break;

  case 31: /* primary_expression: IDENTIFIER  */
#line 141 "proyecto.y"
                        {
					(yyval.d) = buscaPorNom((yyvsp[0].cad));
	}
#line 1292 "proyecto.tab.c"
    break;

  case 32: /* primary_expression: NUMBER  */
#line 144 "proyecto.y"
                                {//usa constante entera
		(yyval.d) = AgregaConstI((yyvsp[0].d));
					
	//| STRING_LITERAL			
	}
#line 1302 "proyecto.tab.c"
    break;

  case 33: /* postfix_expression: primary_expression  */
#line 153 "proyecto.y"
                                {(yyval.d) = (yyvsp[0].d);}
#line 1308 "proyecto.tab.c"
    break;

  case 34: /* unary_expression: postfix_expression  */
#line 156 "proyecto.y"
                                {(yyval.d) = (yyvsp[0].d);}
#line 1314 "proyecto.tab.c"
    break;

  case 35: /* unary_expression: '-' unary_expression  */
#line 157 "proyecto.y"
                                {(yyval.d) = modificaReg((yyvsp[0].d), (yyvsp[0].d), '!');}
#line 1320 "proyecto.tab.c"
    break;

  case 36: /* multiplicative_expression: unary_expression  */
#line 161 "proyecto.y"
                                        {(yyval.d) = (yyvsp[0].d);}
#line 1326 "proyecto.tab.c"
    break;

  case 37: /* multiplicative_expression: multiplicative_expression '*' unary_expression  */
#line 162 "proyecto.y"
                                                                {(yyval.d) = modificaReg((yyvsp[-2].d), (yyvsp[0].d), '*');}
#line 1332 "proyecto.tab.c"
    break;

  case 38: /* multiplicative_expression: multiplicative_expression '/' unary_expression  */
#line 163 "proyecto.y"
                                                                {(yyval.d) = modificaReg((yyvsp[-2].d), (yyvsp[0].d), '/');}
#line 1338 "proyecto.tab.c"
    break;

  case 39: /* additive_expression: multiplicative_expression  */
#line 167 "proyecto.y"
                                        {(yyval.d) = (yyvsp[0].d);}
#line 1344 "proyecto.tab.c"
    break;

  case 40: /* additive_expression: additive_expression '+' multiplicative_expression  */
#line 168 "proyecto.y"
                                                                        {(yyval.d) = modificaReg((yyvsp[-2].d), (yyvsp[0].d), '+');}
#line 1350 "proyecto.tab.c"
    break;
...
#line 173 "proyecto.y"
                                {(yyval.d) = (yyvsp[0].d);}
#line 1362 "proyecto.tab.c"
    break;

  case 43: /* relational_expression: relational_expression '<' relational_expression  */
#line 174 "proyecto.y"
                                                                        {}
#line 1368 "proyecto.tab.c"
    break;

  case 44: /* relational_expression: relational_expression '>' relational_expression  */
#line 175 "proyecto.y"
                                                                        {}
...
#line 180 "proyecto.y"
                                                                        {}
#line 1386 "proyecto.tab.c"
    break;

  case 47: /* assignment_expression: equality_expression  */
#line 184 "proyecto.y"
                                {(yyval.d) = (yyvsp[0].d);}
#line 1392 "proyecto.tab.c"
    break;

  case 48: /* assignment_expression: IDENTIFIER '=' assignment_expression  */
#line 185 "proyecto.y"
                                                { AgregaValI((yyvsp[-2].cad),tabla_de_simbolos[buscaPorReg((yyvsp[0].d))].val);
											

	}
#line 1401 "proyecto.tab.c"
    break;
