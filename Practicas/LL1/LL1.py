from auxiliar import primero, siguiente,Producciones,Terminales,NoTerminales,epsilon, Inicial
...
if not entradasMultiples:
    ...
    pruebaCadenaLL1(prueba)
else:
    print("\nLa gramática no es LL(1), no se pueden probar cadenas")